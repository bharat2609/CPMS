...
Documentation  This will test CPMS functionalities
*** Variables ***

*** Test Cases ***
Test case 1: login to CPMS
    [Documentation]     This will test login functionality to CPMS
    [Tags]   smoke
    open browser    http://supplypartnermanagement-ps101.tmi.telus.com/cpms/loginShow.do?selectedLanguage=en  ff
    ...
    sleep    8s
# Search for channel org

    input text    css=table.bgtbllgreen:nth-child(2) > tbody:nth-child(1) > tr:nth-child(5) > td:nth-child(2) > input:nth-child(1)  04420    04420
...
#Add sales rep
    ...
    input text    css=table.bgtbllgreen > tbody:nth-child(1) > tr:nth-child(10) > td:nth-child(2) > input:nth-child(1)    CPMS
    input text    css=table.bgtbllgreen > tbody:nth-child(1) > tr:nth-child(10) > td:nth-child(4) > input:nth-child(1)    USER
